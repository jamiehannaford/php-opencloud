...
class SubnetTest extends TestCase
{
    ...
    public function test_it_updates()
    {
        ...
        $this->setupMock('PUT', 'v2.0/subnets/id', $expectedJson, [], new Response(200));
    ...
    {
        $this->setupMock('DELETE', 'v2.0/subnets/id', null, [], new Response(202));
    ...
    {
        $this->setupMock('GET', 'v2.0/subnets/id', null, [], 'Network');
