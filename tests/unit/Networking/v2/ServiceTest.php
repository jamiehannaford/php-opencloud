...
use Rackspace\Networking\v2\Api;
...
use Rackspace\Networking\v2\Service;
...
class ServiceTest extends TestCase
{
    ...
    public function test_it_creates_network()
    {
        ...
        $this->setupMock('POST', 'v2.0/networks', $expectedJson, [], new Response(201));
    ...
    public function test_it_creates_subnet()
    {
        ...
        $this->setupMock('POST', 'v2.0/subnets', $expectedJson, ["Content-Type" => "application/json"], new Response(201));
    ...
    public function test_it_creates_port()
    {
        ...
        $this->setupMock('POST', 'v2.0/ports', $expectedJson, [], new Response(201));
